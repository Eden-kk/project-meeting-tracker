...
class MeetingRow(Base):
    ...
    # Phase 2 follow-up — summary paragraph produced by the
    # `meeting-finalization` Hermes skill, persisted at finalize time so
    # the SPA's Summary tab can render it without re-invoking the LLM.
    # NULL until the first successful finalize completes. Re-finalize
    # overwrites in place.
